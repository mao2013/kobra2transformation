 ...
 * specified stereotype. The stereotype is specified by supplying the
 * constructor the qualified name of the stereotype. Qualified names are of the
 * form profileName::stereotypeName.
 */
public class HasStereotypeCondition
	extends Condition {
	 ...
	 *            <code>null</code>.
	 */
	public HasStereotypeCondition(String qualifiedStereotypeName) {
		super();
	...
	public boolean isSatisfied(Object object) {
		...
		if (object instanceof Element) {
			...
			if (srcElement.getAppliedStereotype(qualifiedStereotypeName) != null)
				result = true;
		}
		return result;
	}
