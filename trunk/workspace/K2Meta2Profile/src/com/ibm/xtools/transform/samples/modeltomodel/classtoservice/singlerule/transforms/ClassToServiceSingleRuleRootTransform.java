...
/*
 * File: ClassToServiceSingleRuleRootTransform.java
 */
...
/**
 * Root transform for ClassToServiceSingleRuleTransform, a transformation that
 * converts a class into an interface, an implementation class, and a factory
 * using a single monolothic rule.
 */
public class ClassToServiceSingleRuleRootTransform
	extends RootTransform {

	public final static String ID = "com.ibm.xtools.transform.samples.modeltomodel.class2service.singlerule.root"; //$NON-NLS-1$
	 ...
	 * @param descriptor
	 */
	public ClassToServiceSingleRuleRootTransform(ITransformationDescriptor descriptor) {
		super(descriptor);

		ClassToServiceSingleRuleTransform mainTransform = new ClassToServiceSingleRuleTransform(
			ClassToServiceSingleRuleTransform.ID);
